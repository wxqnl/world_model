...
from wm3d_v3.training.scale5b_config import CODE_RECEIPT_SCHEMA
from wm3d_v3.training.scale5b_runtime import assert_v7_native_dependency_boundary
...
def main() -> None:
    ...
    if scoped_status:
        raise ValueError(
            "refusing to seal a dirty V7 native5b scope:\n" + scoped_status
        )
    evidence = {
