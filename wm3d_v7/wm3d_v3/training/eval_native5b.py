"""Distributed checkpoint evaluation for native WM3D-V7 5B.
...
from wm3d_v3.training.scale5b_config import training_contract_sha256
...
from wm3d_v3.training.train_native5b import (
    _batch_to_device,
    _build_dataset,
    _code_preflight,
...
EVAL_SCHEMA = "wm3d_v7_native5b_checkpoint_eval_v1"
...
def main() -> None:
    ...
    try:
        ...
        manager = Native5BCheckpointManager(checkpoint.parent)
