"""Pinned software-environment contract for native WM3D-V7 5B.
...
ENVIRONMENT_CONTRACT_SCHEMA = "wm3d_v7_native5b_environment_contract_v1"
ENVIRONMENT_RECEIPT_SCHEMA = "wm3d_v7_native5b_environment_receipt_v1"
