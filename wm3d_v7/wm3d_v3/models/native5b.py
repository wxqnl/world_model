...
class MultiViewTokenFuser(nn.Module):
    ...
    def __init__(self, cfg: Native5BConfig):
        super().__init__()
...
def config_from_mapping(mapping: dict) -> Native5BConfig:
