...
CFG=${WM3D_V8_CANARY_CFG:-${RUNTIME_ROOT}/manifests/canary/runtime_config_smoke20_v3.yaml}
SEAL=${WM3D_V8_CANARY_SEAL:-${RUNTIME_ROOT}/manifests/canary/seal_report_smoke20_v3.json}
OUT=${RUNTIME_ROOT}/results/training_canary20_v3
LOG_DIR=${RUNTIME_ROOT}/logs/training_canary20_v3
LOG=${LOG_DIR}/train_rank0.log
PREFLIGHT_LOG=${LOG_DIR}/preflight_full_v3.json
