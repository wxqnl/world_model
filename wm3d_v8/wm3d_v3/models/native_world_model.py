"""Scalable native WM3D V8 core shared by every model-size profile.
...
from wm3d_v3.data.grouped_robot import ACTION_SEMANTIC_IDS


NATIVE_WORLD_MODEL_SCHEMA = "wm3d_v8_native_world_model_v1"
