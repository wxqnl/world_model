...
import wm3d_v3.training.resource_preflight as resource_preflight
import wm3d_v3.training.pretrain as pretrain
...
def test_resource_module_does_not_write_or_delete_paths() -> None:
    source = Path(__file__).resolve().parents[1] / "wm3d_v3/training/resource_preflight.py"
