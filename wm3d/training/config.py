"""Shared configuration and code-lineage contracts for WM3D."""
...
TRAIN_CONFIG_SCHEMA = "wm3d_v7_pretrain_config_v1"
CODE_RECEIPT_SCHEMA = "wm3d_v7_code_receipt_v1"
...
def semantic_training_contract(config: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "model": config["model"],
        "model_budget": config["model_budget"],
...
def verify_code_receipt(
    ...
    *,
    ...
    if receipt.get("root_layout") != "wm3d":
        raise ValueError("code receipt is not rooted at wm3d")
