"""Fail-closed loader for real unified WM3D Stage1 branches."""
...
from wm3d.data.manifest_contract import SHA256_RE
from wm3d.stage1_planner.rollout_audit import read_regular_bytes
