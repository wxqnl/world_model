    ...
    *,
    ...
    if verify_referents:
        ...
        expected_snapshot_paths = {
            ...
            "v7_action_contract": execution_root / "wm3d/data/v7_action_contract.py",
            "v7_contracts": execution_root / "wm3d/data/v7_contracts.py",
            "action_bridge": execution_root / "wm3d/stage1_planner/action_bridge.py",
        }
