"""Unified, embodiment-aware robot state and action contract for WM3D.
...
class GroupedRobotContractError(ValueError):
    """Raised when a sample cannot satisfy the lossless WM3D robot contract."""
...
def panda_single_arm_spec(*, embodiment_id: int = 1) -> EmbodimentSpec:
    """Compatibility profile for WM3D's normalized Panda policy ABI."""
