#!/usr/bin/env python3
"""Re-encode audited real RoboCasa rollouts into unified WM3D Stage1 payloads."""
...
from wm3d.data.grouped_robot import GroupedRobotLimits, pack_grouped_robot_window
from wm3d.data.manifest_contract import (
    load_cache_episode_index,
    load_data_profile,
)
from wm3d.data.episode_robot import _exact_current_states
from wm3d.data.source_adapters import adapt_action_series, load_adapter_contract
from wm3d.data.unified_cache_dataset import _fuse_target_tokens, _pool_masked
from wm3d.encoders.native_vggt import NativeVGGTConfig, NativeVGGTEncoder
from wm3d.stage1_planner.dataset import BRANCH_SCHEMA, GENERATOR_RECEIPT_SCHEMA
...
from wm3d.stage1_planner.train import _stage0_dataset, _verify_runtime_checkout
