#!/usr/bin/env python3
"""Import an audited V7 residual plan into the standard WM3D source ABI."""
...
from wm3d.data.legacy_residual_inventory import import_legacy_residual_plan
from wm3d.data.manifest_contract import sha256_file
from wm3d.data.source_adapters import load_adapter_contract
from wm3d.data.source_inventory import validate_written_inventory
...
def _args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "并生成标准 WM3D source manifest/receipt；不会复制或生成 cache。"
        )
    )
