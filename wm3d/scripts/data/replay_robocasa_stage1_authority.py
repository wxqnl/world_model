...
from wm3d.data.manifest_contract import SHA256_RE, canonical_sha256
...
from wm3d.stage1_planner.execution_snapshot import (
...
from wm3d.training.launch_qualification import verify_clean_runtime_checkout
...
from wm3d.data import v7_action_contract, v7_contracts
from wm3d.stage1_planner import action_bridge
snapshot_modules = {}
for name, module in {
