#!/usr/bin/env python3
"""Audit pinned real RoboCasa same-root rollouts before WM3D re-encoding.
...
from wm3d.stage1_planner.replay_authority import load_replay_authority
...
def main() -> None:
    ...
    if camera_order != [
        ...
        raise RuntimeError("simulator camera ordering differs from WM3D adapter")
