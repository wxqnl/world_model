...
RUN=/0604-10T-test/wm3d_v5/results/wm3d_v5_p64_1b_stage0_native3d_wan_ti2v_actionctx_cf_fsdp_ncclfix_jointpt_stage131_16gpu_20260624_1350
CFG=/data/Minko/world_model/wm3d_v5/configs/v5_p64_1b_stage0_native3d_wan_ti2v_actionctx_cf_fsdp_jointpt_stage131_2node_v1.yaml
mkdir -p "$RUN/logs"
