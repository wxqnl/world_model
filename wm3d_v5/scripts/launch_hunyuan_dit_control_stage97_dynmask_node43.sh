...
RUN_DIR=/0604-10T-test/wm3d_v5/results/hunyuan_dit_control_v5_1b_oxe_stage28wm_context_dynmask_stage97_16gpu_20260618_0145
STAGE96=/0604-10T-test/wm3d_v5/results/hunyuan_dit_control_v5_1b_oxe_stage28wm_norough_contextpath_blockfilm_stage96_16gpu_20260618_0118
...

{
  ...
  echo "init_control_ckpt=${STAGE96}/ckpt/best.pt"
...
/data/Minko/.venvs/wm3d/bin/torchrun \
  ...
  --control_ckpt "${STAGE96}/ckpt/best.pt" \
  --out_dir "${RUN_DIR}" \
