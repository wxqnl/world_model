...
RUN_DIR=/0604-10T-test/wm3d_v5/results/hunyuan_dit_control_v5_1b_oxe_stage97step1000_signflip_stage98_16gpu_20260618_0215
STAGE97=/0604-10T-test/wm3d_v5/results/hunyuan_dit_control_v5_1b_oxe_stage28wm_context_dynmask_stage97_16gpu_20260618_0145
...

{
  ...
  echo "init_control_ckpt=${STAGE97}/ckpt/step_00001000.pt"
...
/data/Minko/.venvs/wm3d/bin/torchrun \
  ...
  --control_ckpt "${STAGE97}/ckpt/step_00001000.pt" \
  --out_dir "${RUN_DIR}" \
