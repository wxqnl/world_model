...
WATCH_LOG="${WATCH_LOG:-${LOG_DIR}/watch_140m_depthplus_4node_test_flow_v1.log}"

STAGE0_RUN="train_140m_stage0_visual_depthplus_4node_test_v1"
STAGE0_CFG="configs/v3_p64_140m_stage0_visual_depthplus_4node_test_v1.yaml"
STAGE0_ROOT="results/wm3d_v3_p64_140m_stage0_visual_depthplus_4node_test_v1"

STAGE1_RUN="train_140m_stage1_dynamics_visual_replay_depthplus_4node_test_v1"
STAGE1_CFG="configs/v3_p64_140m_stage1_dynamics_visual_replay_depthplus_4node_test_v1.yaml"
STAGE1_ROOT="results/wm3d_v3_p64_140m_stage1_dynamics_visual_replay_depthplus_4node_test_v1"

STAGE1P5_RUN="train_140m_stage1p5_hunyuan_bridge_depthplus_4node_test_v1"
STAGE1P5_CFG="configs/v3_p64_140m_stage1p5_hunyuan_bridge_depthplus_4node_test_v1.yaml"
STAGE1P5_ROOT="results/wm3d_v3_p64_140m_stage1p5_hunyuan_bridge_depthplus_4node_test_v1"

STAGE2_RUN="train_140m_stage2_action_scaffold_depthplus_4node_test_v1"
STAGE2_CFG="configs/v3_p64_140m_stage2_action_scaffold_depthplus_4node_test_v1.yaml"
STAGE2_ROOT="results/wm3d_v3_p64_140m_stage2_action_scaffold_depthplus_4node_test_v1"
...
log "flow_start 140m depthplus 4node test stage0->stage2"

launch_stage "${STAGE0_RUN}" "${STAGE0_CFG}" 29720
...
launch_stage "${STAGE1_RUN}" "${STAGE1_CFG}" 29721 "${STAGE0_CKPT}"
...
launch_stage "${STAGE1P5_RUN}" "${STAGE1P5_CFG}" 29722 "${STAGE1_CKPT}"
...
launch_stage "${STAGE2_RUN}" "${STAGE2_CFG}" 29723 "${STAGE1P5_CKPT}"
