...
RUN_DIR=${RUN_DIR:-/0604-10T-test/wm3d_v5/results/hunyuan_latent_decoder_v5_1b_oxe_stage102step1250_wmdelta_actionbasis_stage104_16gpu_20260618_0910}
...
torchrun \
  ...
  --counterfactual_latent_rank_weight 1.0 \
  --counterfactual_latent_rank_margin 0.010 \
  --counterfactual_latent_separation_weight 0.0 \
  --counterfactual_latent_separation_margin 0.030 \
  --action_basis_true_coeff_min_weight 6.0 \
  --action_basis_true_coeff_min_margin 0.05 \
  --action_basis_projected_energy_floor_weight 4.0 \
  --action_basis_projected_energy_floor_ratio 0.08 \
  --counterfactual_coeff_separation_weight 4.0 \
  --counterfactual_coeff_separation_margin 0.05 \
  --counterfactual_coeff_wrong_abs_weight 0.0 \
  --counterfactual_coeff_wrong_abs_margin 0.05 \
  --counterfactual_coeff_opposite_weight 12.0 \
  --counterfactual_coeff_opposite_margin 0.02 \
  --max_train_windows 0 \
  ...
  --train_action_basis_wm_delta_only \
  ...
  --action_basis_residual_scale 0.22 \
  --action_basis_normalizer 0.25 \
  --action_basis_blocks 2 \
  --action_basis_residual_mode wm_delta_project \
  --action_basis_projection_clip 0.60 \
  --action_basis_input_mode scene_only \
  --wm_delta_residual_scale 0.12 \
  --wm_delta_blocks 2 \
