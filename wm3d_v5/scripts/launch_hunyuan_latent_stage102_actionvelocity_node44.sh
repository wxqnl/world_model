...
RUN_DIR=${RUN_DIR:-/0604-10T-test/wm3d_v5/results/hunyuan_latent_decoder_v5_1b_oxe_stage100step2250_actionvelocity_stage102_16gpu_20260618_0435}
...
torchrun \
  ...
  --action_velocity_residual_l1_weight 8.0 \
  --counterfactual_action_mode alternate \
  --counterfactual_every 1 \
  --counterfactual_latent_rank_weight 10.0 \
  --counterfactual_latent_rank_margin 0.030 \
  --counterfactual_latent_separation_weight 5.0 \
  --counterfactual_latent_separation_margin 0.040 \
  --counterfactual_static_l1_weight 0.30 \
  --max_train_windows 0 \
