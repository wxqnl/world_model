...
RUN_DIR=${RUN_DIR:-/0604-10T-test/wm3d_v5/results/hunyuan_latent_decoder_v5_1b_oxe_stage108b_motionfloor_stage109_16gpu_20260618_1545}
...
INIT_CKPT=${INIT_CKPT:-/0604-10T-test/wm3d_v5/results/hunyuan_latent_decoder_v5_1b_oxe_stage107c_contextpixel_teacher_stage108b_16gpu_20260618_1510/ckpt/step_00001250.pt}
...

{
  ...
  echo "motion_floor=decoded 300/0.95 from_first 520/0.90 raw 420/0.95 raw_from_first 620/0.90"
...
torchrun \
  ...
  --decoded_motion_floor_weight 300.0 \
  --decoded_motion_floor_ratio 0.95 \
  --decoded_from_first_l1_weight 180.0 \
  --decoded_from_first_floor_weight 520.0 \
  --decoded_from_first_floor_ratio 0.90 \
  ...
  --decoded_raw_motion_floor_weight 420.0 \
  --decoded_raw_motion_floor_ratio 0.95 \
  --decoded_raw_from_first_l1_weight 900.0 \
  --decoded_raw_from_first_floor_weight 620.0 \
  --decoded_raw_from_first_floor_ratio 0.90 \
