#!/usr/bin/env python3
"""Encode one deterministic shard of the WM3D dataset."""
...
from wm3d.data.codec import JpegPackWriter, quantize_per_vector
...
from wm3d.encoders.vggt_features import VGGTFeatureEncoder
...
def main() -> None:
    ...
    if stats.get("schema") != "wm3d_v7_action_stats_v2":
        raise ValueError("action-statistics schema mismatch")
    if task_index.get("schema") != "wm3d_v7_task_bank_v1":
